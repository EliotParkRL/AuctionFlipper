...
//        return new ArrayList<String>();
     ...
     */
    public static ArrayList<WeaponArmor> createWeaponArmorFromApi(String data, boolean sold) {
        ...
        for (String line : lines) {
            if(line.contains("\"bin\":true")){
                toReturn.add(createWeaponArmor(line, sold));
            }
        }
     ...
     * @return item
     */
    private static WeaponArmor createWeaponArmor(String line, boolean sold) {
